...
See `docs/GEN10_EXPANSION.md`, `catalog/expansion_capacity.json`, `catalog/engine_profiles.json`, `catalog/expanded_rom_layout.json`, and `catalog/expanded_save_layout.json`.
